<div class="widget-box">
    <div class="widget-content tab-content">
		...
		<ul class="nav nav-tabs">
			...
			<?php $clienteatual = $result->idClientes;/*para atualizar os status do Cliente*/
					$soma1 = $result->status++;
...
<?php if($this->permission->checkPermission($this->session->userdata('permissao'),'aHistorico')){ ?>
   <a href="<?php echo base_url()?>index.php/clientes/editar?idClientes=<?php echo $result->idClientes ?>" class="btn btn-success"><i class="icon-plus icon-white"></i> Finalizar Atendimento</a>
<?php } ?>

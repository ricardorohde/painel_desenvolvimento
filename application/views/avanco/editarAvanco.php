                                    ...
                                    <div class="widget-box">
                                          ...
                                          <div class="widget-content nopadding">
                                                ...
                                                <form action="<?php echo current_url(); ?>" id="formServico" method="post" class="form-horizontal" >
                                                    <?php echo form_hidden('idavanco',$result->idavanco) ?>
                                                    <div class="control-group">
                                                            <label for="nome" class="control-label">Técnico<span class="required">*</span></label>
                                                            <div class="controls">
                                                                  <input id="nome" type="text" name="nome" value="<?php echo $result->tecnico_ids_sky ?>"  />
                                                            </div>
                                                      </div>
                                                      <div class="control-group">

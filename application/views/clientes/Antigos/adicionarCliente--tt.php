            ...
            <div class="widget-content nopadding">
                ...
                <form action="<?php echo current_url(); ?>" id="formCliente" method="post" class="form-horizontal" >
				    <div class="control-group">
                        <label for="cep" class="control-label">ID<span class="required">:</span></label>
                        <div class="controls">
					 ...
					 <div class="control-group">
                        <label for="cidade" class="control-label">Referência<span class="required">:</span></label>
                        <div class="controls">
					...
					<div class="control-group">
                        <label for="bairro" class="control-label">Operadora<span class="required">:</span></label>
                        <select id="bairro" name="bairro" class="span2">
								<option value="Selecione sua Operadora" selected="selected">Selecione </option>
                    ...
                    <div class="control-group">
                        <label for="documento" class="control-label">Cliente SKY?<span class="required">:</span></label>
                        <div class="controls">

                        ...
                        <table class="table table-bordered">
							...
							<tr><td colspan="4"></td></tr>
								<tr>
									<td>
                                        <label>
                                            <input name="vHistorico" type="checkbox" class="marcar" id="vHistorico" value="1" <?php if(isset($permissoes['vCliente'])){ if($permissoes['vCliente'] == '1'){echo 'checked';}}?> />
                                            <span class="lbl"> Visualizar Histórico</span>
                                        </label>
                                  </td>

                                    <td>
                                        <label>
                                            <input name="aHistorico" type="checkbox" class="marcar" id="aHistorico" value="1" <?php if(isset($permissoes['aHistorico'])){ if($permissoes['aHistorico'] == '1'){echo 'checked';}}?> />
                                            <span class="lbl"> Adicionar Histórico</span>
                                        </label>
                                    </td>

                                    <td>
                                        <label>
                                            <input name="eHistorico" type="checkbox" class="marcar" id="eHistorico" value="1" <?php if(isset($permissoes['eHistorico'])){ if($permissoes['eHistorico'] == '1'){echo 'checked';}}?> />
                                            <span class="lbl"> Editar Histórico</span>
                                        </label>
                                    </td>
                                    <td>
                                        <label>
                                            <input name="dHistorico" type="checkbox" class="marcar" id="dHistorico" value="1" <?php if(isset($permissoes['dHistorico'])){ if($permissoes['dHistorico'] == '1'){echo 'checked';}}?> />
                                            <span class="lbl"> Excluir Histórico</span>
                                        </label>
                                    </td>
								</tr>
							</tr>
								...
								<tr>
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['vTecnico'])){ if($permissoes['vTecnico'] == '1'){echo 'checked';}}?> name="vTecnico" class="marcar" type="checkbox" value="1" />
                                    ...
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['aTecnico'])){ if($permissoes['aTecnico'] == '1'){echo 'checked';}}?> name="aTecnico" class="marcar" type="checkbox" value="1" />
                                    ...
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['eTecnico'])){ if($permissoes['eTecnico'] == '1'){echo 'checked';}}?> name="eTecnico" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Editar Técnico</span>
                                        </label>
                                    </td>
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['dTecnico'])){ if($permissoes['dTecnico'] == '1'){echo 'checked';}}?> name="dTecnico" class="marcar" type="checkbox" value="1" />
								...
								<tr>
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['vAvanco'])){ if($permissoes['vAvanco'] == '1'){echo 'checked';}}?> name="vAvanco" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Visualizar Avanço</span>
                                        </label>
                                    </td>

                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['aAvanco'])){ if($permissoes['aAvanco'] == '1'){echo 'checked';}}?> name="aAvanco" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Adicionar Avanço</span>
                                        </label>
                                    </td>

                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['eAvanco'])){ if($permissoes['eAvanco'] == '1'){echo 'checked';}}?> name="eAvanco" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Editar Avanço</span>
                                        </label>
                                    </td>
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['dAvanco'])){ if($permissoes['dAvanco'] == '1'){echo 'checked';}}?> name="dAvanco" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Excluir Avanço</span>
                                        </label>
                                    </td>

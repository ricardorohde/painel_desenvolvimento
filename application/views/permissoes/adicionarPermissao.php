                        ...
                        <table class="table table-bordered">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label>
                                            <input name="vHistorico" class="marcar" type="checkbox" checked="checked" value="1" id="vHistorico" />
                                    ...
                                    <td>
                                        <label>
                                            <input name="aHistorico" class="marcar" type="checkbox" value="1" id="aHistorico" />
                                    ...
                                    <td>
                                        <label>
                                            <input name="eHistorico" class="marcar" type="checkbox" value="1" id="eHistorico" />
                                    ...
                                    <td>
                                        <label>
                                            <input name="dHistorico" class="marcar" type="checkbox" value="1" id="dHistorico" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label>
                                            <input name="vTecnico" class="marcar" type="checkbox" checked="checked" value="1" id="vTecnico" />
                                            <span class="lbl"> Visualizar Técnicos</span>
                                        </label>
                                    </td>

                                    <td>
                                        <label>
                                            <input name="aTecnico" class="marcar" type="checkbox" value="1" id="aTecnico" />
                                    ...
                                    <td>
                                        <label>
                                            <input name="eTecnico" class="marcar" type="checkbox" value="1" id="eTecnico" />
                                    ...
                                    <td>
                                        <label>
                                            <input name="dTecnico" class="marcar" type="checkbox" value="1" id="dTecnico" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label>
                                            <input name="vAvanco" class="marcar" type="checkbox" checked="checked" value="1" id="vAvanco" />
                                    ...
                                    <td>
                                        <label>
                                            <input name="aAvanco" class="marcar" type="checkbox" value="1" id="aAvanco" />
                                    ...
                                    <td>
                                        <label>
                                            <input name="eAvanco" class="marcar" type="checkbox" value="1" id="eAvanco" />
                                    ...
                                    <td>
                                        <label>
                                            <input name="dAvanço" class="marcar" type="checkbox" value="1" id="dAvanco" />

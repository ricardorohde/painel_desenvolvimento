                    ...
                    <div class="form-actions">
                        <div class="span12">
                            <div class="span6 offset3">
								...
								<!--Anterior ir para o modal <a href="#modal-confirmar" role="button" data-toggle="modal" cliente="'.$row['sky_codigo'].''" style="margin-right: 1%" class="btn btn-success" title="Inserção"><i class="icon-plus icon-white"></i> Adicionar</a>-->
                                <a href="<?php echo base_url() ?>index.php/insercao/insercao" id="" class="btn"><i class="icon-th-list"></i> Listar e confirmar</a>
...
<!--<div id="modal-confirmar" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <form action="<?php echo base_url() ?>index.php/insercao/insercao" method="post" >

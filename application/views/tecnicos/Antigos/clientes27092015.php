...
<div class="widget-content nopadding">
    ...
    <tbody>
								<?php
									...
									WHERE historico.retorno = 'Sim'
									ORDER BY historico.dataRetorno ASC, historico.horaRetorno DESC";
...
<table class="table table-bordered ">
    ...
    <tbody>
								<?php
								$sql ="SELECT DISTINCT * from clientes WHERE clientesky='Nao' GROUP BY nomeCliente ORDER BY idClientes DESC";
								$query = mysql_query($sql)or die("$sql_error" . mysql_error());

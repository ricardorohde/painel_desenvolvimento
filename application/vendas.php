...
class Vendas extends CI_Controller {
	...
	function gerenciar(){
	    ...
	    $this->data['results'] = $this->vendass_model->get('assinaturas','idPedido,referencia,dataCadastro,nomeCliente,nascimento,sexo,rg,cpf,estadocivil,telefone,celular,telComercial,email,cep,endereco,numero,complemento,bairro,cidade,uf,Bandeira,numeroCartao,Validade,ip,optin','',$config['per_page'],$this->uri->segment(3));
    ...
    public function excluir(){
            ...
            $this->vendas_model->delete('assinaturas','idPedido'); 

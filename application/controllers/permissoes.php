    ...
    function adicionar() {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $permissoes = array(
				  ...
				  'aHistorico' => $this->input->post('aHistorico'),
                  'eHistorico' => $this->input->post('eHistorico'),
                  'dHistorico' => $this->input->post('dHistorico'),
                  'vHistorico' => $this->input->post('vHistorico'),
				  ...
				  'aAvanco' => $this->input->post('aAvanco'),
                  'eAvanco' => $this->input->post('eAvanco'),
                  'dAvanco' => $this->input->post('dAvanco'),
                  'vAvanco' => $this->input->post('vAvanco'),

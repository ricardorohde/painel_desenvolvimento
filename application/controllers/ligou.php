...
class Ligou extends CI_Controller {
    ...
    function __construct() {
        parent::__construct();
            ...
            $this->load->model('ligou_model','',TRUE);
	...
	function gerenciar(){
        ...
        $config['base_url'] = base_url().'index.php/ligou/gerenciar/';
        $config['total_rows'] = $this->ligou_model->count('historico');
        $config['per_page'] = 20;
	    ...
	    $this->data['results'] = $this->ligou_model->get('historico','ligou','',$config['per_page'],$this->uri->segment(3));
       	
       	$this->data['view'] = 'ligou/ligou';
    ...
    function adicionar() {
        ...
        if ($this->form_validation->run('historico') == false) {
            ...
            if ($this->ligou_model->add('historico', $data) == TRUE) {
        ...
        $this->data['view'] = 'ligou/adicionar';
        $this->load->view('tema/topo', $this->data);
    ...
    public function visualizar(){
        ...
        $this->data['view'] = 'ligou/visualizar';
        $this->load->view('tema/topo', $this->data);

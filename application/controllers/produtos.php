...
class Produtos extends CI_Controller {
    ...
    function gerenciar(){
	    ...
	    $this->data['results'] = $this->produtos_model->get('produtos','idProdutos,codigoskyproduto,estoque','',$config['per_page'],$this->uri->segment(3));
    ...
    function adicionar() {
        ...
        if ($this->form_validation->run('produtos') == false) {
            ...
            $data = array(
                'codigoskyproduto' => set_value('descricao'),

...
class Clientes extends CI_Controller {
	...
	function gerenciar(){
	    ...
	    $this->data['results'] = $this->clientes_model->get('clientes','idClientes,referencia,nomeCliente,telefone,celular,operadora,email,clientesky,dataCadastro,atendente,status,ip_lead','',$config['per_page'],$this->uri->segment(3));

...
class Clientes extends CI_Controller {
	...
	function gerenciar(){
	    ...
	    $this->data['results'] = $this->clientes_model->get('clientes','idClientes,nomeCliente,documento,telefone,celular,email,rua,numero,bairro,cidade,estado,cep, atendente, status, tentativa','',$config['per_page'],$this->uri->segment(3));
    ...
    function editar() {
        ...
        if ($this->form_validation->run('clientes') == false) {
            ...
            $data = array(
                ...
                'dataCadastro' => $this->input->post('Y-m-d'),
            );

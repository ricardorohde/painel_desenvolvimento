...
class Insercoes extends CI_Controller {
    ...
    function __construct() {
        ...
        $this->load->model('insercoes_model', '', TRUE);
    ...
    function gerenciar(){
        ...
        $config['base_url'] = base_url().'index.php/insercoes/gerenciar/';
	    ...
	    $this->data['view'] = 'insercoes/insercoes';
    ...
    function adicionar() {
        ...
        if ($this->form_validation->run('produtos') == false) {
            ...
            $data = array(
				...
				'codproduto' => set_value('codproduto'),
        ...
        $this->data['view'] = 'insercoes/adicionarInsercao';
        $this->load->view('tema/topo', $this->data);
